...
public partial class MudExComponentEditDialog<T>
{
    /// <summary>
    ...
    /// </summary>
    [Parameter]
    public string DialogIcon { get; set; } = Icons.Material.Filled.Settings;
    ...
    /// </summary>
    [Parameter]
    public Func<T, MudExComponentEditDialog<T>, Task<string>> CustomSubmit { get; set; }
