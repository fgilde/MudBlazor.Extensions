...
(function () {
    ...
    // tells the editor that this page came up, so it can point at the route when it does not
    var announce = function () {
        try {
            parent.postMessage({ __playzor: 'preview-loaded', path: location.pathname }, location.origin);
        } catch (e) { }
    };
    announce();
