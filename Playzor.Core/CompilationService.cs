...
namespace Playzor.Core
{
    ...
    public class CompilationService
    {
        ...
        /// <summary>
        /// Namespace of the compiled snippet. Fixed: the preview swaps the assembly in under this
        /// identity, and every snippet saved so far declares it in its own .cs files.
        /// </summary>
